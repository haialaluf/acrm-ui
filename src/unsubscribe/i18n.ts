...
/**
 * Translation for the unsubscribe site — deliberately a tiny local shim, not
 ...
 * through a bundled dictionary. A recipient opening a link has no account and no
 ...
 * unsubscribe.delacrm.com, which has no `/locales/` to fetch from.
 */
...
const STORAGE_KEY = "unsubscribe:lang";
 ...
 * unsubscribe link) and no IP lookup (that would be a third-party request from a
