 ...
 *  `scontent.whatsapp.net`) into our own storage and return an internal
 *  storage reference — not a signed URL. Whichever dispatcher eventually
 *  sends this asset resolves it to a real signed URL at send time.
 *
